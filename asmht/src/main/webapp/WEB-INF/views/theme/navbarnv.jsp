...
<div class="border-end bg-white" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        <a class="list-group-item list-group-item-action list-group-item-light p-3" href="/asm/admin/sanpham">Sản phẩm</a>
        <a class="list-group-item list-group-item-action list-group-item-light p-3" href="/asm/admin/mausac">Màu sắc</a>
        <a class="list-group-item list-group-item-action list-group-item-light p-3" href="/asm/admin/kichthuoc">Kích thước</a>
