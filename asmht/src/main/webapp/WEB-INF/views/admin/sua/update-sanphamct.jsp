...
<div class="container mt-5">
    ...
    <form:form method="post" modelAttribute="sanPhamCt" action="/asm/admin/sanphamct/add">
        <div class="form-group">
            ...
            <form:input path="id" cssClass="form-control" value="${sanPhamCt.id}" readonly="true"/>
            <form:errors path="id" cssClass="error text-danger" />
        </div>
        <div class="form-group">
            <label for="maSpct">Mã :</label>
            <form:input path="maSpct" cssClass="form-control" value="${sanPhamCt.maSpct}"/>
        ...
        <div class="form-group">
            ...
            <form:input path="soLuong" cssClass="form-control" value="${sanPhamCt.soLuong}"/>
            <form:errors path="soLuong" cssClass="error text-danger" />
        </div>
        <div class="form-group">
            <label for="gia">Giá :</label>
            <form:input path="gia" cssClass="form-control" value="${sanPhamCt.gia}"/>
