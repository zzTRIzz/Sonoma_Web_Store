...
<div class="container mt-5">
    ...
    <form:form method="post" modelAttribute="sanPham" action="/asm/admin/sanpham/update">
        <div class="form-group">
            <label for="id">Id :</label>
            <form:input path="id" cssClass="form-control" readonly="true" value="${sanPham.id}"/>
            <form:errors path="id" cssClass="error text-danger" />
        </div>
        <div class="form-group">
            <label for="maSp">Mã :</label>
            <form:input path="maSp" cssClass="form-control" value="${sanPham.maSp}"/>
            <form:errors path="maSp" cssClass="error text-danger" />
        </div>
        <div class="form-group">
            <label for="ten">Tên:</label>
            <form:input path="tenSp" cssClass="form-control" value="${sanPham.tenSp}"/>
