...
<div class="container mt-5">
    ...
    <form:form method="post" modelAttribute="mauSac" action="/asm/admin/mausac/update">
        <div class="form-group">
            <label for="id">Id :</label>
            <form:input path="id" cssClass="form-control" readonly="true" value="${mauSac.id}"/>
            <form:errors path="id" cssClass="error text-danger" />
        </div>
        <div class="form-group">
            <label for="ma">Mã :</label>
            <form:input path="ma" cssClass="form-control" value="${mauSac.ma}"/>
            <form:errors path="ma" cssClass="error text-danger" />
        </div>
        <div class="form-group">
            <label for="ten">Tên:</label>
            <form:input path="ten" cssClass="form-control" value="${mauSac.ten}"/>
